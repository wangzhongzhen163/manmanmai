...
// })
// 
myApp.controller('gsproductController',['$scope','$http','$sce','$routeParams',function($scope,$http,$sce,$routeParams){
    ...
    // }
    $scope.boxhow=-1;
    $scope.showctrl=function(index){
        $scope.boxshow=($scope.boxshow===index?-1:index)
    };
